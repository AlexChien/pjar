...
function addImageWithPath(imagePath){
	//imagePath = prompt('Enter the web address of the image', 'http://');
        //alert(imagePath);
	if ((imagePath != null) && (imagePath != "")){
		idEditbox.document.execCommand('InsertImage', false, imagePath);
